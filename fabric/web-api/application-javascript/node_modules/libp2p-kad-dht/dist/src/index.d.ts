...
declare class KadDHT extends EventEmitter {
    ...
    constructor({ libp2p, dialer, peerId, peerStore, registrar, protocolPrefix, forceProtocolLegacy, datastore, kBucketSize, clientMode, concurrency, validators, selectors, randomWalk, onPut, onRemove }: {
        ...
        onPut: ((arg0: import('libp2p-record').Record, arg1: PeerId) => void) | undefined;
        onRemove: ((arg0: import('libp2p-record').Record) => void) | undefined;
    });
    /**
    ...
    contentRouting: {
        provide(key: import("cids")): Promise<void>;
        findProviders(key: import("cids"), options?: {
            timeout?: number | undefined;
    ...
    onPut: (arg0: import('libp2p-record').Record, arg1: PeerId) => void;
    onRemove: (arg0: import('libp2p-record').Record) => void;
    /**
     * Is this DHT running.
     */
     ...
     */
    _verifyRecordLocally(record: import('libp2p-record').Record): Promise<void>;
    /**
     ...
     * @returns {Promise<void>}
     */
    _verifyRecordOnline(record: import('libp2p-record').Record): Promise<void>;
}
...
type Dialer = import("libp2p/src/dialer");
type PeerId = import("peer-id");
type PeerStore = import("libp2p/src/peer-store");
type Registrar = import("libp2p/src/registrar");
