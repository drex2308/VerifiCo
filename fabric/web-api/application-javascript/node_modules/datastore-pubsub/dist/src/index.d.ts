 ...
 */
declare class DatastorePubsub extends Adapter {
    /**
...
declare namespace DatastorePubsub {
    export { PeerId, Validator, SubscriptionKeyFn, PubSubMessage };
}
import { Adapter } from "interface-datastore";
type PubSubMessage = import('libp2p-interfaces/src/pubsub').InMessage;
type PeerId = import('peer-id');
type Validator = import('./types').Validator;
type SubscriptionKeyFn = import('./types').SubscriptionKeyFn;
